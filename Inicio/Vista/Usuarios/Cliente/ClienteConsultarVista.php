                        ...
                        <tbody>
                            <?php foreach ($clientes as $c): ?>
                                <tr>
                                    ...
                                    <td class="text-start ps-3"><?= htmlspecialchars($c['Nombre']) ?></td>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-success"><?= htmlspecialchars($c['Estado']) ?></span>
                                        <?php elseif($c['Estado'] === 'Inactivo'): ?>
                                        <span class="badge bg-secondary"><?= htmlspecialchars($c['Estado']) ?></span>
                                        <?php else: ?>
                                        <span class="badge bg-warning text-dark"><?= htmlspecialchars($c['Estado']) ?></span>
                                        <?php endif; ?>
                                    </td>
